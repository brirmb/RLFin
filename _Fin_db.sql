...
GO
INSERT [dbo].[iiWeb_Module] ([ID], [PID], [Name], [Remark], [URL], [SEQ], [Status], [MUser], [MTime]) VALUES (N'ContractMaintain', N'Contract', N'合同维护', NULL, N'Web/Contract.aspx', 1, N'A', N'Admin', getdate())
GO
INSERT [dbo].[iiWeb_Module] ([ID], [PID], [Name], [Remark], [URL], [SEQ], [Status], [MUser], [MTime]) VALUES (N'DirectInvoice', N'Contract', N'直接开票', NULL, N'Web/DirectInvoice.aspx', 2, N'A', N'Admin', getdate())
GO